...
@Embeddable			//Value type, meaning no id and completely tied to parent lifecycle
public class Image {
...
//    @org.hibernate.annotations.Parent     need this if we want to use Item.id in equals and hashCode. item has to be persisted to work
//    protected Item item;
